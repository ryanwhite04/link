...
public class characterJump : MonoBehaviour
{
    ...
    [SerializeField, Range(0.2f, 1.25f)][Tooltip("How long it takes to reach that height before coming back down")] public float jumpTime = 0.5f;
    ...
    void Update()
    {
        ...
        coyoteTimeCounter = (currentlyJumping || onGround) ? 0 : coyoteTimeCounter + Time.deltaTime;
    }
    ...
    private void setPhysics()
    {
        ...
        Vector2 newGravity = new Vector2(0, (-2 * jumpHeight) / (time * time));
        print(newGravity);
